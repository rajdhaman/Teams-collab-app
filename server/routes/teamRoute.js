...
router.post("/members", roleCheck("ADMIN"), async (req, res) => {
  try {
    const { teamId } = req;
...
router.put("/members/:memberId", roleCheck("ADMIN"), async (req, res) => {
  try {
    const { teamId } = req;
    const { role } = req.body;
...
router.delete("/members/:memberId", roleCheck("ADMIN"), async (req, res) => {
  try {
    const { teamId } = req;
    const { memberId } = req.params;
